                        ...
                        <form id="frmMatricula" @reset.prevent="nuevoMatricula" v-on:submit.prevent="guardarMatricula">
                            <div class="row p-1">
                                ...
                                <div class="col-3 col-md-6">
                                    <v-select-alumnos v-model="matricula.alumno" :options="alumnos"></v-select-alumnos>
                                </div>
                            </div>
                            <div class="row p-1">
                                <div class="col-3 col-md-2">
                            ...
                            <div class="row p-1">
                                ...
                                <div class="col-9 col-md-3">
                                    <input required v-model="matricula.pago" type="checkbox" class="form-check-input" id="txtPagoMatricula">
                                </div>
                            </div>
                            <div class="row p-1">
                                <div class="col-3 col-md-2">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr v-for="matricula in matriculas" :key="matricula.idMatricula" @click="modificarMatricula(matricula)" >
                                    ...
                                    <td><img :src="matricula.comprobante" whidth="50" height="50"></td>
